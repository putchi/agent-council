...
function parseCouncilConfig(configPath) {
  const fallback = {
    council: {
      chairman: { role: 'auto' },
      members: [
        { name: 'codex', command: 'codex exec --ephemeral --skip-git-repo-check', emoji: '🤖', color: 'BLUE' },
...
Usage:
  council-job.sh start [--config path] [--chairman auto|codex|...] [--jobs-dir path] [--json] "question"
