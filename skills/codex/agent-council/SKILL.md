---
name: agent-council
description: Use for consulting role-based AI councils on tech, career, business, or personal decisions, with four member perspectives and a Chairman synthesis.
---

# Agent Council

Run a question through four expert role-based Codex executions, then get a final synthesis from Codex acting as Chairman.
...
- `scripts/chairman.sh` — Codex synthesis engine
- `scripts/call-codex.sh` — shared Codex CLI caller
...
- Personal member scripts — personal council members
